...
| threat-network-exfiltration | `threat.network.outbound` | Detects URLs to suspicious domains often used for exfiltration or C2 | high | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: |
