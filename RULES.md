...
| threat-runtime-obfuscation-general | `threat.runtime.obfuscation.general` | Detects various code obfuscation techniques | medium | :white_check_mark: | :white_check_mark: | | :white_check_mark: | :white_check_mark: | |
...
| threat-process-spawn-silent | `threat.process.spawn.silent` | Detects silent process execution (hidden output, detached processes) | low | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | |
...
| threat-process-injection-dll | `threat.process.injection.dll` | Detects DLL injection, hijacking, and side-loading techniques | high | :white_check_mark: | :white_check_mark: | | :white_check_mark: | :white_check_mark: | |
